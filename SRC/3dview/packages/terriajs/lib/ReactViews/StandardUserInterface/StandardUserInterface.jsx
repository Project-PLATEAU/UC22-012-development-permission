    ...
    getApplication(){
      if(this.props.terria.clickMode === "2" && this.props.terria.authorityJudgment()){
          ...
          .then(res => {
              ...
              if(Object.keys(res).length === 1 && res[0]?.applicationId){
                this.props.viewState.nextApplicationDetailsView(res[0].applicationId);
              }else if(Object.keys(res).length > 1){
                this.props.viewState.showApplicationListView(res);
              }
          }).catch(error => {
